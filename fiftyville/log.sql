...
SELECT * FROM phone_calls JOIN people ON people.phone_number = phone_calls.receiver JOIN bakery_security_logs ON bakery_security_logs.license_plate = people.license_plate
   ...> WHERE bakery_security_logs.day = 28 AND bakery_security_logs.hour = 10 AND bakery_security_logs.activity = "exit" AND phone_calls.duration < 60;
